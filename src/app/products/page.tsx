...
const ProductsContent = () => {
  ...
  // Get all unique categories from products using Set and Array.from
  ...
  useEffect(() => {
    // Using array methods chaining instead of multiple assignments
  ...
  // Using optional chaining and array methods
      ...
      <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {filteredProducts.length > 0 ? (
          filteredProducts.map((product, index) => {
            ...
            const { id, name, image, price, discount, description, rating } =
              product;
